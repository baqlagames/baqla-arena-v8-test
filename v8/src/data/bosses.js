...
export const BOSSES=[
  ...
  {id:10,name:'Astral Lantern Warden',tier:'mini',act:2,color:'#3f6fff',accent:'#ffd166',hp:38000,dmg:165,speed:0.28,atkSpd:54,range:150,size:58,armor:4,magicRes:7,points:600,
    ...
    starfallCD:360,starfallFirst:120,starfallCount:4,starfallDmg:84,starfallRadius:46,
    ...
    lanternOrbitCD:660,lanternOrbitFirst:180,lanternOrbitDmg:54,lanternOrbitShots:6,lanternOrbitPhase:3,
    lanternWardAt:[0.70,0.35],lanternWardShieldPct:0.10,astralBlightDur:300,astralBlightHpPct:0.010,gravityBrandDur:300,gravityBrandHealCut:0.22,gravityTollFrontlineHpPct:0.075,gravityTollTankMult:0.76,gravityTollMeleeMult:0.90,astralBacklineSpellMult:0.86,
  ...
  {id:13,name:'Stormbound Vizier',tier:'mini',act:2,color:'#3f8cff',accent:'#ffd166',hp:26000,dmg:134,speed:0.22,atkSpd:70,range:96,size:50,armor:4,magicRes:9,armorType:'warded',points:900,fixedGoldReward:200,raidAoeDmg:27,spawnFromTop:true,fixedSpawnCenter:true,spawnYOffset:42,entryHold:60,lateRoundScale:false,
    ...
    courtPulseCD:420,courtPulseFirst:120,courtPulseDmg:56,courtPulseTankMult:1.18,courtPulseMeleeMult:0.82,courtPulseBacklineMult:0.70,
