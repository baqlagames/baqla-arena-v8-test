...
export const BOSSES=[
  {id:0,name:'Brood Mother',tier:'mini',act:1,color:'#aa4444',accent:'#5a1818',hp:11200,dmg:105,speed:0.30,atkSpd:60,range:40,size:42,armor:5,magicRes:5,points:300,raidAoeDmg:33,
    ...
    timeEnrageAt:12600},
  {id:1,name:'Hornet Sovereign',tier:'strong',act:1,color:'#c08820',accent:'#7a4a0a',hp:21500,dmg:114,speed:0.42,atkSpd:52,range:60,size:48,armor:7,magicRes:4,points:700,raidAoeDmg:32,spawnFromTop:true,spawnYOffset:52,entryHold:30,
    ...
    royalStingEvery:4,royalStingHpPct:0.035,royalStingPoisonDmg:4,royalStingDur:360,royalStingAmp:1.13,royalHatchlingHpPct:0.024,
