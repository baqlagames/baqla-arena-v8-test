...
export const BOSSES=[
  ...
  {id:3,name:'Veiled Assassin',tier:'mini',act:2,color:'#3a1a1a',accent:'#1a0a0a',hp:3800,dmg:55,speed:0.55,atkSpd:42,range:40,size:42,armor:3,magicRes:3,points:500,
    ...
    timeEnrageAt:8250},
  {id:4,name:'Winterglass Dragon',tier:'vs',act:2,color:'#9fdcff',accent:'#eef8ff',hp:46000,dmg:150,speed:0.35,atkSpd:54,range:92,size:70,armor:10,magicRes:10,points:1500,raidAoeDmg:44,
    ...
    wingBuffetCD:420,wingBuffetFirst:210,wingBuffetDmg:146,wingBuffetRadius:168,wingBuffetTankMult:1.24,wingBuffetMeleeMult:1.02,wingBuffetStun:27,frostbiteDur:210,frostbiteHealCut:0.12,
    iceCometCD:690,iceCometFirst:360,iceCometDmg:150,iceCometRadius:58,iceCometWarn:96,iceCometFall:54,iceCometTargets:4,
    ...
    diamondStormCD:480,diamondStormAt:0.75,diamondStormThresholds:[0.75,0.50,0.25],diamondStormDur:4800,diamondStormTick:120,diamondStormDmg:42,
    ...
    dragonColossusHp:15000,dragonColossusDmg:92,dragonColossusAttack:92,dragonColossusSize:54,dragonColossusArmor:18,dragonColossusMagicRes:0,dragonColossusSurgeDmg:150,dragonColossusSurgeEvery:360,
    dragonJuggernautHp:16500,dragonJuggernautDmg:118,dragonJuggernautAttack:118,dragonJuggernautSize:56,dragonJuggernautArmor:4,dragonJuggernautMagicRes:18,dragonJuggernautCrushDmg:245,dragonJuggernautCrushEvery:264,dragonJuggernautCrushRange:160,
    dragonLandingShieldHp:5000,dragonExposeDur:240,dragonExposeMult:1.00,
  ...
  {id:10,name:'Astral Lantern Warden',tier:'mini',act:2,color:'#3f6fff',accent:'#ffd166',hp:38000,dmg:165,speed:0.28,atkSpd:54,range:150,size:58,armor:4,magicRes:7,points:600,
    ...
    starfallCD:360,starfallFirst:120,starfallCount:4,starfallDmg:77,starfallRadius:46,
    eclipseBeamCD:450,eclipseBeamFirst:270,eclipseBeamDmg:110,eclipseBeamWidth:50,
    ...
    lanternOrbitCD:660,lanternOrbitFirst:180,lanternOrbitDmg:50,lanternOrbitShots:6,lanternOrbitPhase:3,
    lanternWardAt:[0.70,0.35],lanternWardShieldPct:0.10,astralBlightDur:300,astralBlightHpPct:0.0095,gravityBrandDur:300,gravityBrandHealCut:0.22,gravityTollFrontlineHpPct:0.075,gravityTollTankMult:0.76,gravityTollMeleeMult:0.90,astralBacklineSpellMult:0.88,
