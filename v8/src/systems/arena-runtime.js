...
// SCREEN FLOW
// =====================
const arenaScreenUiRuntime=createArenaScreenUiRuntime({
  ctx,
  ...
  gridCols:GRID_COLS,
  gridRows:GRID_ROWS,
  gridX:arenaGridRuntime.gridX,
  gridY:arenaGridRuntime.gridY,
  cellW:arenaGridRuntime.cellW,
  cellH:arenaGridRuntime.cellH,
  screenFlowView:()=>({
    width:W,height:H,frame:combatRuntimeState.frame,
    maxStage:progressState.maxStage,
    beans:progressState.beans,
    stageStars:progressState.stageStars,
    currentStage:campaignState.currentStage,
  ...
  battleHudView:()=>({
    width:W,height:H,arenaTop:ARENA_TOP,arenaBot:ARENA_BOT,
    clashCamera:arenaSceneRenderer.clashCamera,
    ...
    soundMuted:arenaAudio.isMuted()
  }),
  managePanelView:()=>({width:W,height:H,arena,gold:economyState.gold,frame:combatRuntimeState.frame,drawFns,signatures:ARENA_SIGNATURES}),
  pickerView:()=>({width:W,height:H,arena,frame:combatRuntimeState.frame,drawFns}),
  arenaState:()=>arena,
  rootOrder:()=>roleProgression.rootOrder,
  roleRoot:arena_roleRoot,
  ...
  currentStageRounds:arena_currentStageRounds,
  cellScreenQuad:(col,row)=>arena_paintedPlacementActive()?arenaGridRuntime.cellScreenQuad(col,row):null,
  cellScreenPoint:(col,row)=>arena_paintedPlacementActive()?arenaGridRuntime.cellScreenPoint(col,row):null,
