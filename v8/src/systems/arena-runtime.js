...
import { createActorRenderer } from '../render/actor-renderer.js?v=880cef4-shield-visuals';
...
import { updateArenaEnemyAi } from './combat-enemy-ai.js?v=880cef4-shield-visuals';
import { createCombatEnemyRuntime } from './combat-enemy-runtime.js';
import { spawnEnemyByIndex } from './enemy-spawn.js?v=5d94d7b-early-pressure';
import { compactRemovedCombatUnits, tickEnemyCombatUnits, tickPlayerCombatUnits } from './combat-loop.js';
import { createCombatTransientsRuntime } from './combat-transients-runtime.js?v=880cef4-shield-visuals';
...
import { createArenaBossRuntime } from './arena-boss-runtime.js?v=880cef4-shield-visuals';
...
import { createCombatHelperRuntime } from './combat-helper-runtime.js?v=880cef4-shield-visuals';
import { ARENA_BLOODLUST_COST, ARENA_TRANQUILITY_COST, createArenaSpellRuntime } from './arena-spell-runtime.js?v=880cef4-shield-visuals';
...
import { createUnitRuntimeComposition } from './unit-runtime-composition.js?v=880cef4-shield-visuals';
import { createArenaCombatEffectsRuntime } from './arena-combat-effects-runtime.js?v=880cef4-shield-visuals';
...
import { createBattleSceneComposition } from './battle-scene-composition.js?v=880cef4-shield-visuals';
