...
import { createActorRenderer } from '../render/actor-renderer.js?v=7861d9c-text-declutter';
import { createArenaSceneRenderer } from '../render/arena-scene.js?v=7861d9c-text-declutter';
import { installCleanCanvasText } from '../render/text.js';
import { createSpecAccessoryRenderer } from '../render/spec-accessories.js';
import { updateArenaEnemyAi } from './combat-enemy-ai.js?v=7861d9c-text-declutter';
import { createCombatEnemyRuntime } from './combat-enemy-runtime.js';
import { spawnEnemyByIndex } from './enemy-spawn.js?v=7861d9c-text-declutter';
import { compactRemovedCombatUnits, tickEnemyCombatUnits, tickPlayerCombatUnits } from './combat-loop.js';
import { createCombatTransientsRuntime } from './combat-transients-runtime.js?v=7861d9c-text-declutter';
import { createCombatUpdateRuntime } from './combat-update-runtime.js';
import { completeCombatStats, getRoundCombatReport, getStageCombatReport } from './combat-stats.js?v=7861d9c-text-declutter';
import { tickEnemyPostUpdateStatusEffects } from './combat-status-effects.js?v=7861d9c-text-declutter';
import { perkSlotCount, stageBeansReward } from './perks.js';
import { createStageFlowRuntime } from './stage-flow-runtime.js?v=7861d9c-text-declutter';
import { arena_lateRoundEnemyMult, arena_lateStageNormalDamageMult, arena_lateStageNormalDurabilityMult, arena_lateStageRoleHpMult, arena_roundGoldMult, arena_roundsForStage, arena_stageIncome } from './stage-economy.js?v=7861d9c-text-declutter';
import { spawnBossById as spawnBossByIdFromData } from './boss-spawn.js?v=7861d9c-text-declutter';
import { createArenaBossRuntime } from './arena-boss-runtime.js?v=7861d9c-text-declutter';
import { tickTimedFieldEffects } from './timed-field-effects.js?v=7861d9c-text-declutter';
...
import { createUnitMinionRuntime } from './unit-minion-runtime.js?v=7861d9c-text-declutter';
...
import { createCombatHelperRuntime } from './combat-helper-runtime.js?v=7861d9c-text-declutter';
import { ARENA_BLOODLUST_COST, ARENA_TRANQUILITY_COST, createArenaSpellRuntime } from './arena-spell-runtime.js?v=7861d9c-text-declutter';
import { createEnemyMechanicsRuntime } from './enemy-mechanics-runtime.js';
import { createPlacementEconomyRuntime } from './placement-economy-runtime.js?v=7861d9c-text-declutter';
...
import { createUnitRuntimeComposition } from './unit-runtime-composition.js?v=7861d9c-text-declutter';
import { createArenaCombatEffectsRuntime } from './arena-combat-effects-runtime.js?v=7861d9c-text-declutter';
...
import { createBattleSceneComposition } from './battle-scene-composition.js?v=7861d9c-text-declutter';
