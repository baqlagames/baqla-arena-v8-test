...
import { createActorRenderer } from '../render/actor-renderer.js?v=1b60f21-hornet-ease';
import { createArenaSceneRenderer } from '../render/arena-scene.js?v=1b60f21-hornet-ease';
import { installCleanCanvasText } from '../render/text.js';
import { createSpecAccessoryRenderer } from '../render/spec-accessories.js';
import { updateArenaEnemyAi } from './combat-enemy-ai.js?v=1b60f21-hornet-ease';
import { createCombatEnemyRuntime } from './combat-enemy-runtime.js';
import { spawnEnemyByIndex } from './enemy-spawn.js?v=1b60f21-hornet-ease';
import { compactRemovedCombatUnits, tickEnemyCombatUnits, tickPlayerCombatUnits } from './combat-loop.js';
import { createCombatTransientsRuntime } from './combat-transients-runtime.js?v=1b60f21-hornet-ease';
import { createCombatUpdateRuntime } from './combat-update-runtime.js';
import { completeCombatStats, getRoundCombatReport, getStageCombatReport } from './combat-stats.js?v=1b60f21-hornet-ease';
import { tickEnemyPostUpdateStatusEffects } from './combat-status-effects.js?v=1b60f21-hornet-ease';
import { perkSlotCount, stageBeansReward } from './perks.js';
import { createStageFlowRuntime } from './stage-flow-runtime.js?v=1b60f21-hornet-ease';
import { arena_lateRoundEnemyMult, arena_lateStageNormalDamageMult, arena_lateStageNormalDurabilityMult, arena_lateStageRoleHpMult, arena_roundGoldMult, arena_roundsForStage, arena_stageIncome } from './stage-economy.js?v=1b60f21-hornet-ease';
import { spawnBossById as spawnBossByIdFromData } from './boss-spawn.js?v=1b60f21-hornet-ease';
import { createArenaBossRuntime } from './arena-boss-runtime.js?v=1b60f21-hornet-ease';
import { tickTimedFieldEffects } from './timed-field-effects.js?v=1b60f21-hornet-ease';
...
import { createUnitMinionRuntime } from './unit-minion-runtime.js?v=1b60f21-hornet-ease';
...
import { createCombatHelperRuntime } from './combat-helper-runtime.js?v=1b60f21-hornet-ease';
import { ARENA_BLOODLUST_COST, ARENA_TRANQUILITY_COST, createArenaSpellRuntime } from './arena-spell-runtime.js?v=1b60f21-hornet-ease';
import { createEnemyMechanicsRuntime } from './enemy-mechanics-runtime.js';
import { createPlacementEconomyRuntime } from './placement-economy-runtime.js?v=1b60f21-hornet-ease';
...
import { createUnitRuntimeComposition } from './unit-runtime-composition.js?v=1b60f21-hornet-ease';
import { createArenaCombatEffectsRuntime } from './arena-combat-effects-runtime.js?v=1b60f21-hornet-ease';
...
import { createBattleSceneComposition } from './battle-scene-composition.js?v=1b60f21-hornet-ease';
