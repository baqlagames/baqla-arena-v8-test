...
import { createActorRenderer } from '../render/actor-renderer.js?v=f9681f2-hornet-melee';
import { createArenaSceneRenderer } from '../render/arena-scene.js?v=f9681f2-hornet-melee';
import { installCleanCanvasText } from '../render/text.js';
import { createSpecAccessoryRenderer } from '../render/spec-accessories.js';
import { updateArenaEnemyAi } from './combat-enemy-ai.js?v=f9681f2-hornet-melee';
import { createCombatEnemyRuntime } from './combat-enemy-runtime.js';
import { spawnEnemyByIndex } from './enemy-spawn.js?v=f9681f2-hornet-melee';
import { compactRemovedCombatUnits, tickEnemyCombatUnits, tickPlayerCombatUnits } from './combat-loop.js';
import { createCombatTransientsRuntime } from './combat-transients-runtime.js?v=f9681f2-hornet-melee';
import { createCombatUpdateRuntime } from './combat-update-runtime.js';
import { completeCombatStats, getRoundCombatReport, getStageCombatReport } from './combat-stats.js?v=f9681f2-hornet-melee';
import { tickEnemyPostUpdateStatusEffects } from './combat-status-effects.js?v=f9681f2-hornet-melee';
import { perkSlotCount, stageBeansReward } from './perks.js';
import { createStageFlowRuntime } from './stage-flow-runtime.js?v=f9681f2-hornet-melee';
import { arena_lateRoundEnemyMult, arena_lateStageNormalDamageMult, arena_lateStageNormalDurabilityMult, arena_lateStageRoleHpMult, arena_roundGoldMult, arena_roundsForStage, arena_stageIncome } from './stage-economy.js?v=f9681f2-hornet-melee';
import { spawnBossById as spawnBossByIdFromData } from './boss-spawn.js?v=f9681f2-hornet-melee';
import { createArenaBossRuntime } from './arena-boss-runtime.js?v=f9681f2-hornet-melee';
import { tickTimedFieldEffects } from './timed-field-effects.js?v=f9681f2-hornet-melee';
...
import { createUnitMinionRuntime } from './unit-minion-runtime.js?v=f9681f2-hornet-melee';
...
import { createCombatHelperRuntime } from './combat-helper-runtime.js?v=f9681f2-hornet-melee';
import { ARENA_BLOODLUST_COST, ARENA_TRANQUILITY_COST, createArenaSpellRuntime } from './arena-spell-runtime.js?v=f9681f2-hornet-melee';
import { createEnemyMechanicsRuntime } from './enemy-mechanics-runtime.js';
import { createPlacementEconomyRuntime } from './placement-economy-runtime.js?v=f9681f2-hornet-melee';
...
import { createUnitRuntimeComposition } from './unit-runtime-composition.js?v=f9681f2-hornet-melee';
import { createArenaCombatEffectsRuntime } from './arena-combat-effects-runtime.js?v=f9681f2-hornet-melee';
...
import { createBattleSceneComposition } from './battle-scene-composition.js?v=f9681f2-hornet-melee';
