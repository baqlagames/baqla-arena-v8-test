...
import { dealDamageRuntime, handleCombatDeath } from './combat-damage-runtime.js?v=905b2c3-thunder-shield';
...
import { playerCombatColor, spawnPlayerAbilityCastVfx, spawnPlayerImpactVfx, spawnPlayerProjectileCastVfx } from './combat-vfx.js?v=905b2c3-thunder-shield';
...
export function createCombatHelperRuntime(deps = {}) {
  ...
  function addGoldShieldRuntime(target, amount, duration, cap, noExpireHeal) {
    return addGoldShield(target, amount, { duration, cap, noExpireHeal, tickHz, emitParticle: addParticle });
  }
