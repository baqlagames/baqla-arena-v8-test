import { createCodexReferenceScreens } from './codex-reference-screens.js';
...
function arena_passiveShort(id){
  const m={
    ...
    ardentDefender:'Cheat death: revive at 40% HP + 1s invulnerability (once per wave). After used, grants 20% DR for 5s every 45s',
...
function abilityLabel(name){
  const labels={
    ...
    guardianOfAncientKings:'12s: +50% armor, 30% DR, heal 1.5% max HP/sec (45s CD)',
