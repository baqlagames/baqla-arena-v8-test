...
function smokeAstralWarden(ctx, boss) {
  ...
  if (Math.abs((wardenTemplate.astralBacklineSpellMult || 0) - 0.92) > 0.0001) throw new Error('Astral Warden backline spell multiplier should be 92%');
  if (Math.abs((boss.astralBacklineSpellMult || 0) - 0.92) > 0.0001) throw new Error('Astral Warden spawned backline spell multiplier should remain unscaled at 92%');
